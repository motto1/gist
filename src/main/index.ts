...
import './services/NovelCharacterMemoryService'
import './services/NovelCharacterService'
import './services/NovelOutlineMemoryService'
import './services/NovelOutlineService'
import {
  READ_NO_MORE_PROTOCOL,
  handleProtocolUrl,
...
if (!app.requestSingleInstanceLock()) {
  ...
  app.whenReady().then(async () => {
    ...
    electronApp.setAppUserModelId(import.meta.env.VITE_MAIN_BUNDLE_ID || 'com.motto1.readnomore')
  ...
  const handleOpenUrl = (args: string[]) => {
    const url = args.find((arg) => arg.startsWith(READ_NO_MORE_PROTOCOL + '://'))
