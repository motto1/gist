...
import BaseLoader from '@main/knowledge/rag/loaders/BaseLoader'
import { cleanString } from '@main/knowledge/rag/utils/string'
 ...
 */
export class EpubLoader extends BaseLoader<{ filePath: string }> {
  ...
  constructor(options: EpubLoaderOptions) {
    super(`EpubLoader_${md5(options.filePath)}`, { filePath: options.filePath }, options.chunkSize, options.chunkOverlap)
