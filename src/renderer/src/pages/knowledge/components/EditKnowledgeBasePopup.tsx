      ...
      window.modal.confirm({
        ...
        content: (
          <div className="flex flex-col items-start gap-1">
            ...
            <span className="pl-4">{`${t('knowledge.migrate.source_model')}: ${base.model.name}`}</span>
            <span className="pl-4">{`${t('knowledge.migrate.target_model')}: ${newBase.model.name}`}</span>
            <span>{t('knowledge.dimensions')}:</span>
            <span className="pl-4">{`${t('knowledge.migrate.source_dimensions')}: ${base.dimensions}`}</span>
            <span className="pl-4">{`${t('knowledge.migrate.target_dimensions')}: ${newBase.dimensions}`}</span>
          </div>
        ),
