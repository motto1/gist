    ...
    <GlassPanel paddingClassName="p-6" className="space-y-6">
        ...
        <div className="grid grid-cols-1 gap-4">
          <div className="space-y-2">
            <div className="text-foreground/60 text-sm">解说音频</div>
          ...
          <div className="space-y-2">
            <div className="text-foreground/60 text-sm">时间轴 JSON（可选）</div>
            <div className="flex gap-2">
              <Input
                value={ttsJson}
          ...
          <div className="space-y-2">
            <div className="text-foreground/60 text-sm">背景音乐（可选）</div>
            <div className="flex gap-2">
              <Input
                value={bgm}
          ...
          <div className="space-y-2">
            <div className="text-foreground/60 text-sm">输出文件</div>
            <div className="flex gap-2">
              <Input
                value={out}
          ...
          <div className="space-y-2">
            <div className="text-foreground/60 text-sm">解说文案</div>
            <Textarea
              value={script}
