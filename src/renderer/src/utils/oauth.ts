...
export const oauthWithAihubmix = async (setKey) => {
  const authUrl = `https://aihubmix.com/token?client_id=read_no_more_oauth&lang=${getLanguageCode()}&aff=SJyh`
  ...
  const messageHandler = async (event) => {
    ...
    if (data && data.key === 'read_no_more_oauth_callback') {
...
export const providerCharge = async (provider: string) => {
  const chargeUrlMap = {
    ...
    aihubmix: {
      url: `https://aihubmix.com/topup?client_id=read_no_more_oauth&lang=${getLanguageCode()}&aff=SJyh`,
      width: 720,
      height: 900
    },
    tokenflux: {
    ...
    ppio: {
      url: 'https://ppio.com/user/register?invited_by=JYT9GD&utm_source=github_read-no-more&redirect=/billing',
      width: 900,
      height: 700
    },
    '302ai': {
...
export const providerBills = async (provider: string) => {
  const billsUrlMap = {
    ...
    aihubmix: {
      url: `https://aihubmix.com/statistics?client_id=read_no_more_oauth&lang=${getLanguageCode()}&aff=SJyh`,
      width: 900,
      height: 700
    },
    tokenflux: {
    ...
    ppio: {
      url: 'https://ppio.com/user/register?invited_by=JYT9GD&utm_source=github_read-no-more&redirect=/billing/billing-details',
      width: 900,
      height: 700
    },
    '302ai': {
