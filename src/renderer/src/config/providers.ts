...
export const SYSTEM_PROVIDERS_CONFIG: Record<SystemProviderId, SystemProvider> = {
  readnomore: {
    ...
    models: SYSTEM_MODELS.readnomore,
    isSystem: true,
    enabled: false
  },
  silicon: {
  ...
  'fast-read-experience': {
    id: 'fast-read-experience',
    name: 'fast-read-experience',
    type: 'openai',
    apiKey: 'sk-77afd493283c4c3c8c0b3e7504e43a14',
    apiHost: 'https://dashscope.aliyuncs.com/compatible-mode/v1/',
    models: SYSTEM_MODELS['fast-read-experience'],
    isSystem: true,
    enabled: true,
    fixedModels: true
  },
...
export const PROVIDER_LOGO_MAP: AtLeast<SystemProviderId, string> = {
  ...
  'fast-read-experience': BailianProviderLogo,
...
export const PROVIDER_URLS: Record<SystemProviderId, ProviderUrls> = {
  ...
  ppio: {
    ...
    websites: {
      official: 'https://ppio.com/user/register?invited_by=JYT9GD&utm_source=github_read-no-more&redirect=/',
      apiKey:
        'https://ppio.com/user/register?invited_by=JYT9GD&utm_source=github_read-no-more&redirect=/settings/key-management',
      docs: 'https://ppio.com/model-api?invited_by=JYT9GD&utm_source=github_read-no-more',
      models: 'https://ppio.com/model-api/product/llm-api?invited_by=JYT9GD&utm_source=github_read-no-more'
    }
  },
  gemini: {
    api: {
  ...
  alayanew: {
    ...
    websites: {
      official: 'https://www.alayanew.com/backend/register?id=read-no-more',
      apiKey: ' https://www.alayanew.com/backend/register?id=read-no-more',
      docs: 'https://docs.alayanew.com/docs/modelService/interview?utm_source=read-no-more',
      models: 'https://www.alayanew.com/product/deepseek?id=read-no-more'
    }
  },
  openrouter: {
    api: {
