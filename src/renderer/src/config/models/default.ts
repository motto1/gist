...
export const deepseekV31Model: Model = {
  id: 'deepseek-v3.1',
  name: 'deepseek-v3.1',
...
export const SYSTEM_MODELS: Record<SystemProviderId | 'defaultModel', Model[]> = {
  ...
  'fast-read-experience': [
    { id: 'deepseek-v3.1', name: 'deepseek-v3.1', provider: 'fast-read-experience', group: 'deepseek', owned_by: 'system' },
    { id: 'qwen-flash', name: 'qwen-flash', provider: 'fast-read-experience', group: 'qwen-flash', owned_by: 'system' }
  ],
  stepfun: [
    {
      id: 'step-1-8k',
