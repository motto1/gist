...
```bash
npm install @readnomore/ai-core ai
```
...
```typescript
import { AiCore } from '@readnomore/ai-core'
...
```typescript
import { createOpenAIExecutor } from '@readnomore/ai-core'
...
```typescript
import { registerProvider, AiCore } from '@readnomore/ai-core'
...
```typescript
import { webSearchPlugin } from '@readnomore/ai-core/built-in/plugins'
...
```typescript
import { createLoggingPlugin } from '@readnomore/ai-core/built-in/plugins'
...
```typescript
import { createPromptToolUsePlugin } from '@readnomore/ai-core/built-in/plugins'
...
```typescript
import { definePlugin } from '@readnomore/ai-core'
...
```typescript
import { createClient } from '@readnomore/ai-core'
...
更强大的是，你还可以将自定义注册表与本包的插件系统结合使用：

```typescript
import { PluginEnabledAiClient } from '@readnomore/ai-core'
import { createProviderRegistry } from 'ai'
import { createOpenAI } from '@ai-sdk/openai'
import { anthropic } from '@ai-sdk/anthropic'
