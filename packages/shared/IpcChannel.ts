export enum IpcChannel {
  ...
  // Novel Compression
  NovelCompress_Compress = 'novel-compress:compress',
  NovelCompress_CompressWithMultipleModels = 'novel-compress:compress-with-multiple-models',
  NovelCompress_Progress = 'novel-compress:progress',
  NovelCompress_Start = 'novel-compress:start',
  NovelCompress_ChunkStart = 'novel-compress:chunk-start',
  NovelCompress_ChunkComplete = 'novel-compress:chunk-complete',
  NovelCompress_Log = 'novel-compress:log',

  // Novel Compression Memory Service
  NovelCompress_GetState = 'novel-compress:get-state',
  NovelCompress_SetState = 'novel-compress:set-state',
  NovelCompress_ResetState = 'novel-compress:reset-state',
  NovelCompress_Cancel = 'novel-compress:cancel',
  NovelCompress_StateUpdated = 'novel-compress:state-updated',
  NovelCompress_AutoResumeTriggered = 'novel-compress:auto-resume-triggered',
  NovelCompress_ParseChapters = 'novel-compress:parse-chapters',

  // Novel Character
  NovelCharacter_Start = 'novel-character:start',
  NovelCharacter_Cancel = 'novel-character:cancel',
  NovelCharacter_GetState = 'novel-character:get-state',
  NovelCharacter_SetState = 'novel-character:set-state',
  NovelCharacter_ResetState = 'novel-character:reset-state',
  NovelCharacter_StateUpdated = 'novel-character:state-updated',
  NovelCharacter_AutoResumeTriggered = 'novel-character:auto-resume-triggered',
  NovelCharacter_ExportAllCharacters = 'novel-character:export-all-characters',
  NovelCharacter_ExportSingleCharacter = 'novel-character:export-single-character',
  NovelCharacter_ParseChapters = 'novel-character:parse-chapters',  // 解析章节
  NovelCharacter_GenerateSecondary = 'novel-character:generate-secondary',

  // Novel Outline (大纲提取器)
  NovelOutline_Start = 'novel-outline:start',
  NovelOutline_Cancel = 'novel-outline:cancel',
  NovelOutline_GetState = 'novel-outline:get-state',
  NovelOutline_SetState = 'novel-outline:set-state',
  NovelOutline_ResetState = 'novel-outline:reset-state',
  NovelOutline_StateUpdated = 'novel-outline:state-updated',
  NovelOutline_AutoResumeTriggered = 'novel-outline:auto-resume-triggered',
  NovelOutline_ExportAllOutlines = 'novel-outline:export-all-outlines',
  NovelOutline_ExportSingleOutline = 'novel-outline:export-single-outline',
  NovelOutline_LoadJSON = 'novel-outline:load-json',
  ...
  TextEditorLibrary_GetBooks = 'text-editor-library:get-books',
  TextEditorLibrary_ImportBook = 'text-editor-library:import-book',
  TextEditorLibrary_UpdateTitle = 'text-editor-library:update-title',
  TextEditorLibrary_DeleteBook = 'text-editor-library:delete-book',
  TextEditorLibrary_GetBookContent = 'text-editor-library:get-book-content',
  TextEditorLibrary_OpenReadView = 'text-editor-library:open-read-view',
  TextEditorLibrary_ConvertAllToUtf8 = 'text-editor-library:convert-all-to-utf8',

  // TXT Reader (TXT阅读器)
  TextEditorLibrary_GetChapters = 'text-editor-library:get-chapters',
  TextEditorLibrary_SaveChapters = 'text-editor-library:save-chapters',
  TextEditorLibrary_ReparseChapters = 'text-editor-library:reparse-chapters',

  // TextBooks Utils (图书工具函数)
  TextBooks_GenerateFolderName = 'textbooks:generate-folder-name',
  TextBooks_GetTextBooksDir = 'textbooks:get-textbooks-dir',

  // Text Reader Cache (阅读器缓存)
  TextReader_OpenBook = 'text-reader:open-book',
  TextReader_ReadChapter = 'text-reader:read-chapter',
  TextReader_GetCacheIndex = 'text-reader:get-cache-index',
  TextReader_RebuildCache = 'text-reader:rebuild-cache',
  TextReader_CacheUpdated = 'text-reader:cache-updated',
